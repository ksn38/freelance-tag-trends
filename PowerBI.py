...
'''Data_for_PowerBI_hh('../Temp/tags/Intern/', '\d|[А-яё]', 'hh/tags/Intern_cyr').norm_and_save_files()
t1 = time.time()
dirs = listdir('../Temp/tags/')
for d in dirs:
    Data_for_PowerBI_hh('../Temp/tags/' + d, r'\d|[A-z]', 'hh/tags/' + d).norm_and_save_files()
t2 = time.time() - t1'''
